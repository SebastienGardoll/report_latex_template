...
% option showtrims : with trim marks.

%%% EXAMPLE OF WEB PUBLICATION %%%
%\documentclass[french,a4paper,12pt,article,oneside,onecolumn,openany,extrafontsizes,final]{memoir}

%%% EXAMPLE OF PAPER PUBLICATION %%%
\documentclass[french,a4paper,12pt,article,twoside,onecolumn,openright,extrafontsizes,final]{memoir}
